          ...
          <div class="relative lg:ml-10">
            ...
            <blockquote class="relative">
              <div class="text-2xl font-medium leading-9 text-gray-900">
                <p>The CAD tools are incredibly intuitive, and the CNC automation has significantly reduced errors. I can't imagine going back to our old workflow!</p>
              </div>
              <footer class="mt-8">
                <div class="flex">
                  ...
                  <div class="ml-4 lg:ml-0">
                    <div class="text-base font-medium text-gray-900">Sarah Wilson</div>
                    <div class="text-base font-medium text-sky-900"> Design Manager, Modern Interiors</div>
                  </div>
                </div>
              </footer>
            </blockquote>
