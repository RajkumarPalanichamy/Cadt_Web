<template>
    <div class="px-8 py-10 bg-gradient-to-r from-white via-sky-50 to-sky-200 ...">
       <div class="px-10">
           <h3 class="mt-2 text-3xl font-bold flex justify-center items-center leading-8 tracking-tight text-sky-900 sm:text-4xl ">Why Choose Us?</h3>
           <p class="text-black pt-7 pb-10 pr-8 flex font-semibold justify-center text-2xl">
