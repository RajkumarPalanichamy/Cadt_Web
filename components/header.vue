      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <NuxtLink :to="'/contact'" class="text-lg font-semibold text-gray-900 hover:text-gray-700">
            <button class="p-2 bg-sky-900 text-white rounded-md hover:shadow-md hover:bg-slate-100 hover:font-bold hover:text-sky-700 first-letter:">Get Consultation</button> 
          </NuxtLink>
        </div>
      </nav>
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              ...
              <div class="py-4">
                <NuxtLink :to="'/contact'" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold text-gray-900 hover:bg-gray-50">
                  <button class="p-2 bg-sky-900 rounded-md">Get Consultation</button>
                </NuxtLink>
              </div>
            </div>
          </div>
